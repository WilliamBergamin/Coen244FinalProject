...
Direct::Direct(string n) : Graph(n){
    
}


Direct::Direct(const Direct& copyDirectGraph) : Graph(copyDirectGraph){
}
                ...
                do{
                    ...
                    if(!stop(search2)){
                        ...
                        if(found2 == false){
                            ...
                            if(copylink == true){
                                cout<<things[numnode1].getname()<<" is alredy linked to "<<things[numnode2].getname()<< endl;
                            }
                        }
                    }else{
                        found2=true;
